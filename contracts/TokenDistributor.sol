...
import {INFTSeaToken} from "./interfaces/INFTSeaToken.sol";

/**
 * @title TokenDistributor
 * @notice It handles the distribution of NFTS token.
 * It auto-adjusts block rewards over a set number of periods.
 */
contract TokenDistributor is ReentrancyGuard {
    using SafeERC20 for IERC20;
    using SafeERC20 for INFTSeaToken;
    ...
    INFTSeaToken public immutable NFTSeaToken;
    ...
    /**
     * @notice Constructor
     * @param _NFTSeaToken NFTS token address
    ...
    constructor(
        ...
        uint256 nonCirculatingSupply = INFTSeaToken(_NFTSeaToken).SUPPLY_CAP() -
            INFTSeaToken(_NFTSeaToken).totalSupply();
        ...
        // 2. Store values
        NFTSeaToken = INFTSeaToken(_NFTSeaToken);
    ...
    function deposit(uint256 amount) external nonReentrant {
        ...
        // Transfer NFTS tokens to this contract
    ...
    function withdraw(uint256 amount) external nonReentrant {
        ...
        // Transfer NFTS tokens to the sender
        NFTSeaToken.safeTransfer(msg.sender, amount);
    ...
    function withdrawAll() external nonReentrant {
        ...
        // Transfer NFTS tokens to the sender
        NFTSeaToken.safeTransfer(msg.sender, amountToTransfer);
    ...
    function _updatePool() internal {
        ...
        if (tokenRewardForStaking > 0) {
            ...
            bool mintStatus = NFTSeaToken.mint(address(this), tokenRewardForStaking);
            if (mintStatus) {
                accTokenPerShare = accTokenPerShare + ((tokenRewardForStaking * PRECISION_FACTOR) / totalAmountStaked);
            }

            NFTSeaToken.mint(tokenSplitter, tokenRewardForOthers);
        }
